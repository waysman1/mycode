...
while(True):      #sets up an infinite loop condition 
    ...
    if (answer == '255.255.255.255'):  #logic to check if user gave the correct answer
        print('Correct!')
        break             #breaks statement escapes the while loop
    elif (thisround == 3):  #logic to ensure reound has not reached 3
