...
def get_ip_data():
    ...
    input_drinker = input("How many beers has this guy drank? ")
    input_brand = input("\nWhat brand does he drink? ")
    d = {"IP": input_ip, "driver": input_driver, "Beers": input_drinker, "Brand": input_brand}
    return d
...
print("The file " + filename + ".xls should be in your local directory")#!/usr/bin/env python3
